package com.example.mvc.web.frontcontroller.v5.adapter;

import com.example.mvc.web.frontcontroller.ModelView;
import com.example.mvc.web.frontcontroller.v3.ControllerV3;
import com.example.mvc.web.frontcontroller.v5.MyHandlerAdapter;
...
public class ControllerV3HandlerAdapter implements MyHandlerAdapter {
    ...
    public ModelView handle(HttpServletRequest req, HttpServletResponse resp, Object handler) throws ServletException, IOException {
        ...
        ModelView process = controller.process(paramMap);
        return process;
    }
